---
title: Températures dans les villes Françaises - Editions de rapports automatisés avec Rmarkdown.
author: V. Tolon
date: 28 avril 2020
output:
  pdf_document:
...
source("chargement librairies.R")
```
...
>>>>>>> e9a10af8d5467ad97c5620944e15fb40460790aa
```
...
```{r graphtemp, echo = F,eval=T,fig.height = 5, fig.width = 6,fig.cap="Courbes de températures mensuelles par Rg"}
#température moyenne
...
```{r indiv, echo = T,eval=T,fig.cap="Cercle des corrélations",fig.height =5 , fig.width = 5}
res <- PCA(datatemp, quanti.sup=13:16, quali.sup=17,graph=F)
...
```{r circle, echo = T,eval=T,fig.cap="Nuage des individus",fig.height = 5, fig.width = 5, fig.align = "center",}
